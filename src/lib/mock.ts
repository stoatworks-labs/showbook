...
export const mockApi: Api = {
  ...
  bundleExport: () => notDesktop('Bundle export'),
  bundleExportAwc: () => notDesktop('Bundle export'),
  lppSummary: async () => null,
  lppAttach: () => notDesktop('Attaching a LivePremier Plus configuration'),
  lppExport: () => notDesktop('LivePremier Plus configuration export'),
  lppDetach: () => notDesktop('Editing a LivePremier Plus configuration'),
